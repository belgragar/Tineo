...
1. **Objetivo**: Aprender a usar la búsqueda avanzada de Google Imágenes para encontrar imágenes específicas.
2. **Instrucciones**:
   - Abre tu navegador web y ve a [Google Imágenes](https://images.google.com).
   - En la barra de búsqueda, escribe "paisajes naturales".
...
2. **Instrucciones**:
   - Busca en Google Imágenes una imagen en formato JPG y otra en formato PNG.
...
2. **Instrucciones**:
   - Utiliza Google Imágenes para buscar "fondos de pantalla HD".
...
2. **Instrucciones**:
   - Busca en Google Imágenes imágenes en formato JPG y PNG. Puedes usar términos como "logo en PNG" o "foto en JPG".
...
Estos ejercicios ayudarán a los principiantes a familiarizarse con conceptos básicos de fotografía digital y a desarrollar habilidades prácticas en la búsqueda y manejo de imágenes en línea.
